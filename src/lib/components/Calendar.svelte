...
<div class="toplevel">
    <!-- Rubrik rad-->
    <div class="inline-flex text-center"><div class="w-20 text-center border border-black">{now.getFullYear()}</div><div class="w-28 border border-l-0 border-black">Måndag</div><div class="w-28  border border-l-0 border-black">Tisdag</div><div class="w-28 border border-l-0 border-black">Onsdag</div><div class="w-28 border border-l-0 border-black">Torsdag</div><div class="w-28 border border-l-0 border-black">Fredag</div><div class="w-28 border border-l-0 border-black">Lördag</div><div class="w-28 border border-l-0 border-black">Söndag</div></div>
